...
<header class="hero-section">
    <div class="hero-image-container position-relative">
        ...
        <img src="{{ Vite::asset('resources/images/2.jpeg') }}" class="img-fluid w-100" alt="Pemandangan Desa Konoha" style="max-height: 500px;">
...
<section class="py-5" id="profildesa">
    <div class="container px-4">
        <div class="row gx-5 align-items-center">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded mb-5 mb-lg-0" src="{{ Vite::asset('resources/images/1.jpeg') }}" alt="Foto Desa Konoha" />
            </div>
        </div>
    </div>
</section>
...
<div class="carousel-item active">
    <img src="{{ Vite::asset('resources/images/lead1.png') }}" class="d-block w-100" alt="Foto Kepala Desa">
...
<div class="carousel-item">
    <img src="{{ Vite::asset('resources/images/lead2.png') }}" class="d-block w-100" alt="Foto Sekretaris Desa">
     {{-- TAMBAHKAN KELAS 'caption-background' DI SINI --}}
    <div class="carousel-caption d-none d-md-block caption-background">
...
{{-- Item 3 --}}
<div class="carousel-item">
    <img src="{{ Vite::asset('resources/images/lead3.png') }}" class="d-block w-100" alt="Foto Bendahara Desa">
     {{-- TAMBAHKAN KELAS 'caption-background' DI SINI --}}
    <div class="carousel-caption d-none d-md-block caption-background">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="{{ Vite::asset('resources/images/news1.png') }}" alt="..." />
             ...
             <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="{{ Vite::asset('resources/images/news2.png') }}" alt="..." />
                    <div class="card-body p-4">
             ...
             <div class="col-lg-4 mb-5">
                <div class="card h-100 shadow border-0">
                    <img class="card-img-top" src="{{ Vite::asset('resources/images/news4.png') }}" alt="..." />
                    <div class="card-body p-4">
